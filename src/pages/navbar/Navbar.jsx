    ...
    return (
        <nav className='flex items-center md:flex-col '>
            <div onClick={() => setOpen(!open)} className='md:hidden w-[50%]'>
               ...
               </div><hr className='w-[90%] m-auto hidden md:block md:mb-10' />
                 
            <div className="flex flex-row items-center justify-between w-full md:mb-6">
                ...
                <div>
                    <h3 className='text-2xl md:text-5xl'>Cook&Meal</h3>
                    ...
                    <div className="dropdown dropdown-end ">
                        ...
                        <ul tabIndex={0}
                            ...
                            menu-sm dropdown-content bg-base-100 rounded-box w-28 md:w-44">
                            <li>
